...
const inventoryItems = [
  { id: 1, name: "Tomatoes", category: "Produce", quantity: 25, unit: "kg", status: "In Stock" },
  { id: 2, name: "Chicken Breast", category: "Meat", quantity: 15, unit: "kg", status: "Low Stock" },
  { id: 3, name: "Olive Oil", category: "Pantry", quantity: 10, unit: "liters", status: "In Stock" },
  { id: 4, name: "Basmati Rice", category: "Grains", quantity: 20, unit: "kg", status: "In Stock" },
  { id: 5, name: "Parmesan Cheese", category: "Dairy", quantity: 5, unit: "kg", status: "Low Stock" },
  { id: 6, name: "Black Pepper", category: "Spices", quantity: 3, unit: "kg", status: "In Stock" },
];
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-stone-100">
              ...
              <th className="text-left py-3 px-4 text-sm font-medium text-stone-600 border-b border-stone-200">Quantity</th>
